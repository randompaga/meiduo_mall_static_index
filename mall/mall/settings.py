...
# FastDFS
FDFS_URL = 'http://192.168.12.26:8888/'  # 访问图片的路径域名 ip地址修改为自己机器的ip地址
...
HAYSTACK_CONNECTIONS = {
    'default': {
        ...
        'URL': 'http://192.168.12.26:9200/',  # 此处为elasticsearch运行的服务器ip地址，端口号固定为9200
